...
export default function MindmapDetailPanel({ 
  ...
  return (
    <div className="fixed inset-y-0 right-0 z-50 flex w-96 flex-col overflow-y-auto border-l border-slate-200 bg-white shadow-2xl dark:border-slate-700 dark:bg-slate-900">
