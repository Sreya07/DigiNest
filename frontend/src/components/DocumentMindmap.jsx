    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full rounded-lg border border-slate-300 bg-white py-2 pl-10 pr-4 text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-800 dark:text-white"
          />
        </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 rounded-lg bg-slate-100 px-4 py-2 transition hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700"
      ...
      >
        ...
        {filteredBranches.map((branch) => {
          ...
          const Icon = iconMap[branch.icon] || FileText;
          ...
          return (
            ...
            >
              ...
              {/* Label Below */}
              {isSelected && (
                <div className="absolute left-1/2 top-full mt-2 -translate-x-1/2 rounded bg-slate-900 px-2 py-1 text-xs font-semibold text-white dark:bg-white dark:text-slate-900">
        ...
        {filteredBranches.map((branch) => (
          ...
          >
            <div className="flex items-start justify-between mb-3">
              ...
              <span className="rounded-md bg-white/20 px-2 py-1 text-xs font-bold opacity-80">
                {branch.documents.length} docs
              </span>
            </div>
