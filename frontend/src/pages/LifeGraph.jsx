  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_360px]">
        <section className="h-[430px] rounded-lg border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <aside className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <div className="mt-5 space-y-3">
            {selected.items.map((item) => (
              <div key={item} className="rounded-lg bg-blue-50 p-4 font-semibold text-blue-800 dark:bg-blue-950 dark:text-blue-200">{item}</div>
            ))}
          </div>
        </aside>
      </div>
