...
>>>>>>> main:src/pages/Register.jsx
          <ShieldCheck size={28} />
        </div>
        <h1 className="mt-5 text-center text-3xl font-bold text-slate-950 dark:text-white">Create your nest</h1>
        <p className="mt-2 text-center text-slate-500 dark:text-slate-400">Join DigiNest to manage your digital legacy securely.</p>
...
=======
        <input 
          ...
          className="mt-2 w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none focus:border-emerald-400 dark:border-slate-700 dark:bg-slate-950 dark:text-white" 
        ...
        <input 
          ...
          placeholder="••••••••" 
        />
        <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">Min 6 characters</p>
        
        <button 
          className="mt-6 w-full rounded-2xl bg-emerald-500 px-5 py-3 font-semibold text-white hover:bg-emerald-600 disabled:opacity-50" 
          type="submit"
          disabled={isLoading}
        >
