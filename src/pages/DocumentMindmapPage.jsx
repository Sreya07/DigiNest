import { Zap, Book, Loader2 } from "lucide-react";
...
export default function DocumentMindmapPage() {
  ...
  if (loading) {
    return <div className="flex justify-center py-24"><Loader2 size={36} className="animate-spin text-purple-600" /></div>;
  }
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-slate-600 dark:text-slate-400">
              Explore your citizen data as an interconnected knowledge graph based on your real documents.
            </p>
          </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-2xl bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950 dark:to-cyan-950 border border-blue-200 dark:border-blue-800 p-4">
          ...
          <p className="text-sm text-blue-800 dark:text-blue-200">The mindmap dynamically groups your uploaded documents by their category.</p>
        </div>
        <div className="rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950 border border-green-200 dark:border-green-800 p-4">
          ...
          <p className="text-sm text-green-800 dark:text-green-200">Data never leaves your browser. The nodes map metadata fields directly from MongoDB.</p>
        </div>
        <div className="rounded-2xl bg-gradient-to-br from-purple-50 to-fuchsia-50 dark:from-purple-950 dark:to-fuchsia-950 border border-purple-200 dark:border-purple-800 p-4">
          ...
          <p className="text-sm text-purple-800 dark:text-purple-200">Understand what data intersects across categories before approving consent requests.</p>
        </div>
      </div>
      ...
      {documents.length > 0 ? (
        ...
        <div className="rounded-2xl border-2 border-dashed border-slate-300 dark:border-slate-700 p-12 text-center h-[500px] flex items-center justify-center">
          <div>
            <p className="text-slate-500 dark:text-slate-400">No documents found. Upload some to generate the mindmap.</p>
          </div>
        </div>
      )}
