...
export default function ReminderCard({ reminder }) {
  ...
  return (
    <div className="flex items-center gap-4 rounded-3xl border border-slate-100 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
      <div className={`grid h-11 w-11 place-items-center rounded-2xl ${urgent ? "bg-rose-50 text-rose-600 dark:bg-rose-950 dark:text-rose-200" : "bg-blue-50 text-blue-600 dark:bg-blue-950 dark:text-blue-200"}`}>
